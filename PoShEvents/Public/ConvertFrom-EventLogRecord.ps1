    ...
    process {
        ...
        switch ($EventRecordType) {
            ...
            'AccountManagementEvent' {
                ...
                New-Object -Property $Event -TypeName PSCustomObject | Add-Member -TypeName 'MyEvent.EventRecordType.AccountManagementEvent' -PassThru
            }
            default {
